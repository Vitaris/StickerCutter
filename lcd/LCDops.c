...
void int2LCD(char pos[], int input, int max_width){
    LCDgoto(pos); 
    char* str;
    asprintf (&str, "%*i", max_width, input);
    LCDwriteMessage(str);
    free(str);
}

void float2LCD(char pos[], float input, int max_width){
    LCDgoto(pos); 
    char* str;
    asprintf (&str, "%*.2f", max_width, input);
    LCDwriteMessage(str);
    free(str);
}

void string2LCD(char pos[], char input[]){
    LCDgoto(pos); 
    LCDwriteMessage(input);
}
